...
var TextLayer, convertTextLayers, data, flipCard, map, module, myText, ref, x;

ref = __webpack_require__(1), TextLayer = ref.TextLayer, convertTextLayers = ref.convertTextLayers;

flipCard = __webpack_require__(2);

module = __webpack_require__(3);

data = JSON.parse(Utils.domLoadDataSync('Untitled-1psd/jsonInfo.json'));

map = Framer.Importer.load("Untitled-1", {
  scale: 1
});
